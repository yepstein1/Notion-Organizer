    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-6 flex items-center justify-center">
      <div className="max-w-3xl w-full bg-white rounded-3xl shadow-2xl p-8 border-2 border-indigo-200">
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-blue-900 mb-2">Connect Your Notion Database</h3>
              <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
                ...
                <li>Copy the "Internal Integration Token" and set it in the backend env as `NOTION_TOKEN`</li>
        ...
        <div className="space-y-6">
          ...
          <button
            onClick={onConnect}
            disabled={isProcessing || !databaseId}
